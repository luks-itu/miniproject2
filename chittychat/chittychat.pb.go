...
var file_chittychat_proto_rawDesc = []byte{
	...
	0x32, 0x79, 0x0a, 0x0a, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x22,
...
var file_chittychat_proto_depIdxs = []int32{
	1, // 0: ChatServer.Join:input_type -> Connection
	1, // 1: ChatServer.Leave:input_type -> Connection
	0, // 2: ChatServer.Publish:input_type -> Message
	2, // 3: ChatServer.Join:output_type -> ResponseCode
	2, // 4: ChatServer.Leave:output_type -> ResponseCode
	2, // 5: ChatServer.Publish:output_type -> ResponseCode
